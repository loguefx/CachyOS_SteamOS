...
failed=0
for suite in test-display.py test-watch.py test-steam-restart.py test-exit.py test-audio.py test-hdmi-audio.py test-shortcut.py test-app.py test-controllers.py test-pad-layouts.py test-display-choice.py test-gamescope-args.py; do
    printf '\n===== %s =====\n' "$suite"
